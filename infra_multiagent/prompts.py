...
def return_instructions_root() -> str:
    ...
    - If the question relates to Principal Architect reference materials, guidelines, or best practices, or other related technical topics like **"AI Adoption"** or **"Vertex AI"**, use the **`call_ask_rag_agent`** tool.
    ...
    <TASK>
        ...
        # 3. **Analyze Data TOOL (`call_ds_agent` - if applicable):** If the user's request **explicitly asks for data science tasks, python analysis, or visualization**, use this tool. Do not use this tool to simply summarize or present data retrieved from the database.
        ...
        # 6. **RAG Tool (`call_ask_rag_agent` - if applicable):** If the user's query relates to Principal Architect reference materials or other technical topics like Vertex AI, use this tool to retrieve information from the knowledge base.
        ...
        #   * **RAG Tool `call_ask_rag_agent`:** Use this tool if the user asks for it. Ensure that:
