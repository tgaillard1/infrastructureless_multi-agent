...
def return_instructions_root() -> str:
    ...
    - If the user's question pertains to principal architects, call the `ask_rag_agent`.
    - When calling `ask_rag_agent`, pass the user's exact request as the `question` argument.
